...
public interface ConcTree {
    ...
    public class Program {
        ...
        public String toString(String indent) {
            return indent + "<Program>\n" + ident.toString(indent + '\t') + auxGlobCpsDecl.toString(indent + '\t')
                    + blockCmd.toString(indent + '\t') + indent + "</Program>\n";
        }
    ...
    public class AuxGlobCpsDecl {
        ...
        public String toString(String indent) {
            return indent + "<AuxGlobCpsDecl>\n" + cpsDecl.toString(indent + '\t') + indent + "</AuxGlobCpsDecl>\n";
        }
    ...
    public class CpsDecl {
        ...
        public String toString(String indent) {
            return indent + "<CpsDecl>\n" + decl.toString(indent + '\t') + repDecl.toString(indent + '\t') + indent
                    + "</CpsDecl>\n";
        }
    ...
    public abstract class Decl {
        ...
        public AbsTree.Decl toAbstract(RepDecl repDecl) {
            return null;
        }
    }
    ...
    public class StoreDecl extends Decl {
        ...
        public String toString(String indent) {
            return indent + "<StoreDecl>\n" + auxChangeMode.toString(indent + '\t') + ident.toString(indent + '\t')
                    + type.toString(indent + '\t') + indent + "</StoreDecl>\n";
        }

        public AbsTree.DeclStore toAbstract(RepDecl repDecl) {
            return new AbsTree.DeclStore(auxChangeMode.toAbstract(), ident, type,
                    (repDecl != null ? repDecl.toAbstract() : null));
        }
    }
    ...
    public class FunDecl extends Decl {
        ...
        public FunDecl(Ident ident, ParamList paramList, StoreDecl storeDecl, AuxGlobImpList auxGlobImpList,
                AuxLocCpsDecl auxLocCpsDecl, BlockCmd blockCmd) {
            this.ident = ident;
        ...
        public String toString(String indent) {
            return indent + "<FunDecl>\n" + ident.toString(indent + '\t') + paramList.toString(indent + '\t')
                    + storeDecl.toString(indent + '\t') + auxGlobImpList.toString(indent + '\t')
                    + auxLocCpsDecl.toString(indent + '\t') + blockCmd.toString(indent + '\t') + indent
                    + "</FunDecl>\n";
        }

        public AbsTree.DeclFun toAbstract(RepDecl repDecl) {
            return new AbsTree.DeclFun(ident, paramList.toAbstract(), storeDecl.toAbstract(null),
                    auxGlobImpList.toAbstract(), auxLocCpsDecl.toAbstract(), blockCmd.toAbstract(),
                    repDecl.toAbstract());
        }
    }
    ...
    public class ProcDecl extends Decl {
        ...
        public ProcDecl(Ident ident, ParamList paramList, AuxGlobImpList auxGlobImpList, AuxLocCpsDecl auxLocCpsDecl,
                BlockCmd blockCmd) {
            this.ident = ident;
            this.paramList = paramList;
            this.auxGlobImpList = auxGlobImpList;
        ...
        public String toString(String indent) {
            return indent + "<ProcDecl>\n" + ident.toString(indent + '\t') + paramList.toString(indent + '\t')
                    + auxGlobImpList.toString(indent + '\t') + auxLocCpsDecl.toString(indent + '\t')
                    + blockCmd.toString(indent + '\t') + indent + "</ProcDecl>\n";
        }

        public AbsTree.DeclProc toAbstract(RepDecl repDecl) {
            return new AbsTree.DeclProc(ident, paramList.toAbstract(), auxGlobImpList.toAbstract(),
                    auxLocCpsDecl.toAbstract(), blockCmd.toAbstract(), repDecl.toAbstract());
        }
    }
    ...
    public class ParamList {
        ...
        public String toString(String indent) {
            return indent + "<ParamList>\n" + auxParamList.toString(indent + '\t') + indent + "</ParamList>\n";
        }
    ...
    public class AuxParamList {
        ...
        public String toString(String indent) {
            return indent + "<AuxParamList>\n" + param.toString(indent + '\t') + repParam.toString(indent + '\t')
                    + indent + "</AuxParamList>\n";
        }
    ...
    public class Param {
        ...
        public String toString(String indent) {
            return indent + "<Param>\n" + auxFlowMode.toString(indent + '\t') + auxMechMode.toString(indent + '\t')
                    + storeDecl.toString(indent + '\t') + indent + "</Param>\n";
        }

        public AbsTree.Param toAbstract(RepParam repParam) {
            return new AbsTree.Param(auxFlowMode.toAbstract(), auxMechMode.toAbstract(), storeDecl.toAbstract(null),
                    repParam.toAbstract());
        }
    }
    ...
    public class RepParam {
        ...
        public String toString(String indent) {
            return indent + "<RepParam>\n" + param.toString(indent + '\t') + repParam.toString(indent + '\t') + indent
                    + "</RepParam>\n";
        }
    ...
    public class RepIdent {
        ...
        public String toString(String indent) {
            return indent + "<RepIdent>\n" + ident.toString(indent + '\t') + repIdent.toString(indent + '\t') + indent
                    + "</RepIdent>\n";
        }
    ...
    public class AuxGlobImpList {
        ...
        public String toString(String indent) {
            return indent + "<AuxGlobImpList>\n" + globImpList.toString(indent + '\t') + indent + "</AuxGlobImpList>\n";
        }
    ...
    public class GlobImpList {
        ...
        public String toString(String indent) {
            return indent + "<GlobImpList>\n" + globImp.toString(indent + '\t') + repGlobImp.toString(indent + '\t')
                    + indent + "</GlobImpList>\n";
        }
    ...
    public class GlobImp {
        ...
        public String toString(String indent) {
            return indent + "<GlobImp>\n" + auxFlowMode.toString(indent + '\t') + auxChangeMode.toString(indent + '\t')
                    + ident.toString(indent + '\t') + indent + "</GlobImp>\n";
        }

        public AbsTree.GlobImp toAbstract(RepGlobImp repGlobImp) {
            return new AbsTree.GlobImp(auxFlowMode.toAbstract(), auxChangeMode.toAbstract(), ident,
                    repGlobImp.toAbstract());
        }
    }
    ...
    public class AuxChangeMode {
        ...
        public String toString(String indent) {
            return indent + "<AuxChangeMode>\n" + changeMode.toString(indent + '\t') + indent + "</AuxChangeMode>\n";
        }
    ...
    public class AuxLocCpsDecl {
        ...
        public String toString(String indent) {
            return indent + "<AuxLocCpsDecl>\n" + cpsDecl.toString(indent + '\t') + indent + "</AuxLocCpsDecl>\n";
        }
    ...
    public class AuxFlowMode {
        ...
        public String toString(String indent) {
            return indent + "<AuxFlowMode>\n" + flowMode.toString(indent + '\t') + indent + "</AuxFlowMode>\n";
        }

        public FlowMode toAbstract() {
            return flowMode;
        }
    }
    ...
    public class AuxFlowModeEps extends AuxFlowMode {
        ...
        public FlowMode toAbstract() {
            return new FlowMode(ModeAttribute.IN);
        }
    }
    ...
    public class AuxMechMode {
        ...
        public String toString(String indent) {
            return indent + "<AuxMechMode>\n" + mechMode.toString(indent + '\t') + indent + "</AuxMechMode>\n";
        }

        public MechMode toAbstract() {
            return mechMode;
        }
    }
    ...
    public class AuxMechModeEps extends AuxMechMode {
        ...
        public MechMode toAbstract() {
            return new MechMode(ModeAttribute.COPY);
        }
    }
    ...
    public class BlockCmd {
        ...
        public String toString(String indent) {
            return indent + "<BlockCmd>\n" + cmd.toString(indent + '\t') + repCmd.toString(indent + '\t') + indent
                    + "</BlockCmd>\n";
        }
    ...
    public class CmdExpr extends Cmd {
        ...
        public String toString(String indent) {
            return indent + "<CmdExpr>\n" + expr.toString(indent + '\t') + auxExprCmd.toString(indent + '\t') + indent
                    + "</CmdExpr>\n";
        }
    ...
    public class CmdCall extends Cmd {
        ...
        public String toString(String indent) {
            return indent + "<CmdCall>\n" + ident.toString(indent + '\t') + exprList.toString(indent + '\t')
                    + auxGlobInitList.toString(indent + '\t') + indent + "</CmdCall>\n";
        }

        public AbsTree.CmdProcCall toAbstract(RepCmd repCmd) {
            return new AbsTree.CmdProcCall(new AbsTree.RoutineCall(ident, exprList.toAbstract()),
                    auxGlobInitList.toAbstract(), repCmd.toAbstract());
        }
    }
    ...
    public class CmdWhile extends Cmd {
        ...
        public String toString(final String indent) {
            return indent + "<CmdWhile>\n" + expr.toString(indent + '\t') + blockCmd.toString(indent + '\t') + indent
                    + "</CmdWhile>\n";
        }
    ...
    public class CmdInvarFor extends Cmd {
        ...
        public String toString(final String indent) {
            return indent + "<CmdInvarFor>\n" + loopCounterInit.toString(indent + '\t')
                    + condition.toString(indent + '\t') + step.toString(indent + '\t')
                    + invariant.toString(indent + '\t') + blockCmd.toString(indent + '\t') + indent
                    + "</CmdInvarFor>\n";
        }
    ...
    public class CmdIf extends Cmd {
        ...
        public String toString(String indent) {
            return indent + "<CmdIf>\n" + expr.toString(indent + '\t') + ifCmd.toString(indent + '\t')
                    + elseCmd.toString(indent + '\t') + indent + "</CmdIf>\n";
        }
    ...
    public class CmdQuest extends Cmd {
        ...
        public String toString(String indent) {
            return indent + "<CmdQuest>\n" + expr.toString(indent + '\t') + indent + "</CmdQuest>\n";
        }
    ...
    public class CmdExcl extends Cmd {
        ...
        public String toString(String indent) {
            return indent + "<CmdExcl>\n" + expr.toString(indent + '\t') + indent + "</CmdExcl>\n";
        }
    ...
    public class AuxGlobInitList {
        ...
        public String toString(String indent) {
            return indent + "<AuxGlobInitList>\n" + globInitList.toString(indent + '\t') + indent
                    + "</AuxGlobInitList>\n";
        }

        public AbsTree.GlobInit toAbstract() {
            return globInitList.toAbstract();
        }
    }
    ...
    public class GlobInitList {
        ...
        public String toString(String indent) {
            return indent + "<GlobInitList>\n" + ident.toString(indent + '\t') + repIdent.toString(indent + '\t')
                    + indent + "</GlobInitList>\n";
        }
    ...
    public class ExprList {
        ...
        public String toString(String indent) {
            return indent + "<ExprList>\n" + auxExprList.toString(indent + '\t') + indent + "</ExprList>\n";
        }
    ...
    public class AuxExprList {
        ...
        public String toString(String indent) {
            return indent + "<AuxExprList>\n" + expr.toString(indent + '\t') + repExpr.toString(indent + '\t') + indent
                    + "</AuxExprList>\n";
        }
    ...
    public class AuxExprCmdBecomes extends AuxExprCmd {
        ...
        public String toString(String indent) {
            return indent + "<AuxExprCmdBecomes>\n" + expr.toString(indent + '\t') + indent + "</AuxExprCmdBecomes>\n";
        }
    ...
    public class Expr {
        ...
        public String toString(String indent) {
            return indent + "<Expr>\n" + term1.toString(indent + '\t') + repTerm1.toString(indent + '\t') + indent
                    + "</Expr>\n";
        }
    ...
    public class Term1 {
        ...
        public String toString(String indent) {
            return indent + "<Term1>\n" + term2.toString(indent + '\t') + repTerm2.toString(indent + '\t') + indent
                    + "</Term1>\n";
        }
    ...
    public class RepTerm1 {
        ...
        public String toString(String indent) {
            return indent + "<RepTerm1>\n" + boolOpr.toString(indent + '\t') + term1.toString(indent + '\t')
                    + repTerm1.toString(indent + '\t') + indent + "</RepTerm1>\n";
        }
    ...
    public class Term2 {
        ...
        public String toString(String indent) {
            return indent + "<Term2>\n" + term3.toString(indent + '\t') + repTerm3.toString(indent + '\t') + indent
                    + "</Term2>\n";
        }
    ...
    public class RepTerm2 {
        ...
        public String toString(String indent) {
            return indent + "<RepTerm2>\n" + relOpr.toString(indent + '\t') + term2.toString(indent + '\t')
                    + repTerm2.toString(indent + '\t') + indent + "</RepTerm2>\n";
        }
    ...
    public class Term3 {
        ...
        public String toString(String indent) {
            return indent + "<Term3>\n" + factor.toString(indent + '\t') + repFactor.toString(indent + '\t') + indent
                    + "</Term3>\n";
        }
    ...
    public class RepTerm3 {
        ...
        public String toString(String indent) {
            return indent + "<RepTerm3>\n" + addOpr.toString(indent + '\t') + term3.toString(indent + '\t')
                    + repTerm3.toString(indent + '\t') + indent + "</RepTerm3>\n";
        }
    ...
    public class RepFactor {
        ...
        public String toString(String indent) {
            return indent + "<RepFactor>\n" + multOpr.toString(indent + '\t') + factor.toString(indent + '\t')
                    + repFactor.toString(indent + '\t') + indent + "</RepFactor>\n";
        }
    ...
    public class FactorLiteral extends Factor {
        ...
        public String toString(String indent) {
            return indent + "<FactorLiteral>\n" + literal.toString(indent + '\t') + indent + "</FactorLiteral>\n";
        }
    ...
    public class FactorIdent extends Factor {
        ...
        public String toString(String indent) {
            return indent + "<FactorIdent>\n" + ident.toString(indent + '\t') + auxIdent.toString(indent + '\t')
                    + indent + "</FactorIdent>\n";
        }
    ...
    public class FactorMonadicOpr extends Factor {
        ...
        public String toString(String indent) {
            return indent + "<FactorMonadicOpr>\n" + monadicOpr.toString(indent + '\t')
                    + factor.toString(indent + '\t') + indent + "</FactorMonadicOpr>\n";
        }
    ...
    public class FactorExpr extends Factor {
        ...
        public String toString(String indent) {
            return indent + "<FactorExpr>\n" + expr.toString(indent + '\t') + indent + "</FactorExpr>\n";
        }
    ...
    public class MonadicOpr {
        ...
        public String toString(String indent) {
            return indent + "<MonadicOpr>\n" + operator.toString(indent + '\t') + indent + "</MonadicOpr>\n";
        }
